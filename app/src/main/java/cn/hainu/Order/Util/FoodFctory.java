...
import cn.hainu.Order.domain.Food;
import cn.hainu.Order.domain.Product;
...
public class FoodFctory {
     ...
     static  public List<Product> initDatas() {
          ...
          Product product = new Product(0, "雪花",50, R.drawable.xuehua, 220, "", "牛运动最为频繁的一块活肉！", false);
          productsData.add(product);
          product = new Product(1, "匙柄",40, R.drawable.chibing, 340,"", "纹理清晰~口感甜嫩无渣！", false);
          productsData.add(product);
          product = new Product(2,"匙仁",52, R.drawable.chiren, 572, "", "肉质柔嫩且多汁~滋味无穷！", false);
          productsData.add(product);
          product = new Product(3,"三花趾",38, R.drawable.sanhuazhi, 678, "", "牛前腿的腱子肉~", false);
          productsData.add(product);
          product = new Product(4, "五花趾",38, R.drawable.wuhuazhi, 441, "", "纹理清晰~肉质爽口！", false);
          productsData.add(product);
          product = new Product(5,"肥胼",42, R.drawable.feipin, 233, "", "口感肥腻细嫩，富有牛脂香味~", false);
          productsData.add(product);
          product = new Product(6, "吊龙",40, R.drawable.diaolong, 128, "", "鲜甜弹牙~登峰造极的美味！", false);
          productsData.add(product);
          product = new Product(7, "嫩肉",36, R.drawable.nengrou, 214, "", "精肉无油~味道甜美！", false);
          productsData.add(product);
          product = new Product(8, "胸口朥",45, R.drawable.xiongkoulao, 82, "", "清甜间+牛油的香味~脆而爽口！", false);
          productsData.add(product);
          product = new Product(9, "牛肉丸",38, R.drawable.wanzi, 520, "", "纯肉打造！！不可错过！", false);
          productsData.add(product);
          return productsData;
     }
}
